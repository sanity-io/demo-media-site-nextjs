...
export default async function handler(req: NextRequest) {
  ...
  // Validate type
  if (!['article', 'person', 'section', 'podcast', 'newsletter'].includes(type)) {
    throw new Error('Invalid type')
  }

  const doc = await getClient(false).fetch(`*[_type == "${type}" && _id == $id][0]`, { id })
          ...
          <div tw="bg-purple-300 h-full flex">
            <div tw="h-full flex flex-col p-8 py-12">
              <h2 tw="flex items-center text-3xl sm:text-4xl font-extrabold tracking-tight text-black text-left">
                <span tw="text-purple-300 inline-block pr-2"><svg width="19" height="19"
  ...
  <path
    ...
    fill="#BB9FF9" />
              ...
              <div
                tw="flex flex-col md:flex-row flex-wrap w-full pt-4 md:items-center justify-between">
