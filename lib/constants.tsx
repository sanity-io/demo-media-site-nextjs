...
export type Brand = {
  name: string
  title: string
  structure: (SchemaItem | SchemaDivider)[]
}
...
export const SCHEMA_ITEMS_MEDIA: (SchemaItem | SchemaDivider)[] = [
...
export const SCHEMA_ITEMS_BLOG: (SchemaItem | SchemaDivider)[] = [
  { schemaType: `article`, title: 'Articles', icon: FiFeather },
  'divider',
...
export const BRANDS: Brand[] = [
  {
    name: 'media',
    title: 'Media',
    structure: SCHEMA_ITEMS_MEDIA,
  },
  {
    name: 'blog',
    title: 'Blog',
    structure: SCHEMA_ITEMS_BLOG,
  },
]
