...
$parcel$export(module.exports, "workflow", () => $329a1cedcedb1349$export$66caea4fbc555daf, (v) => $329a1cedcedb1349$export$66caea4fbc555daf = v);
...
function $9b2a1e1488934d06$export$2e2bcd8739ae039(props) {
    ...
    const { navigateIntent: navigateIntent  } = (0, $dyHF6$sanity_unstable.useRouter)();
    return /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Button), {
...
function $a48cfb6131de1b2b$export$2e2bcd8739ae039(props) {
    ...
    const visibleUsers = (0, ($parcel$interopDefault($dyHF6$react))).useMemo(()=>users.slice(0, max), [
        users
    ]);
    if (!users?.length) return null;
    return /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Flex), {
        align: "center",
        children: [
            visibleUsers.map((user)=>/*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Box), {
                    style: {
                        marginRight: -5
                    },
                    children: /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanity_unstable.UserAvatar), {
                        user: user
                    }, void 0, false, {
            ...
            len > max && /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Box), {
                paddingLeft: 2,
...
function $5acb438b2707cb7e$export$2e2bcd8739ae039(props) {
    const { assignees: assignees , userList: userList , documentId: documentId  } = props;
    const client = (0, $dyHF6$sanity.useClient)();
    const toast = (0, $dyHF6$sanityui.useToast)();
    const [openId, setOpenId] = (0, ($parcel$interopDefault($dyHF6$react))).useState(``);
    const addAssignee = (0, ($parcel$interopDefault($dyHF6$react))).useCallback((id, userId)=>{
        client.patch(`workflow-metadata.${id}`).setIfMissing({
            assignees: []
        }).insert(`after`, `assignees[-1]`, [
            userId
        ]).commit().then((res)=>res).catch((err)=>{
            console.error(err);
            return toast.push({
    ...
    const removeAssignee = (0, ($parcel$interopDefault($dyHF6$react))).useCallback((id, userId)=>{
        client.patch(`workflow-metadata.${id}`).unset([
            `assignees[@ == "${userId}"]`
        ]).commit().then((res)=>res).catch((err)=>{
            console.error(err);
            return toast.push({
    ...
    const clearAssignees = (0, ($parcel$interopDefault($dyHF6$react))).useCallback((id)=>{
        client.patch(`workflow-metadata.${id}`).unset([
            `assignees`
        ]).commit().then((res)=>res).catch((err)=>{
            console.error(err);
    ...
    return /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Popover), {
        // @ts-ignore
        // ref={setPopoverRef}
        // onKeyDown={handleKeyDown}
        content: /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanitypluginutils.UserSelectMenu), {
            // open={false}
            style: {
                maxHeight: 300
            },
        ...
        portal: true,
        open: openId === documentId,
        children: !assignees || assignees.length === 0 ? /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Button), {
            ...
            lineNumber: 104,
            columnNumber: 9
        }, this) : /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Button), {
            onClick: ()=>setOpenId(documentId),
            padding: 0,
            mode: "bleed",
            style: {
            ...
            children: /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $a48cfb6131de1b2b$export$2e2bcd8739ae039), {
...
function $d5ee3dea3f734309$export$6a639350e64e609c(props) {
    ...
    return /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Box), {
        paddingY: 2,
        paddingX: 3,
        children: /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Card), {
            radius: 2,
                ...
                children: [
                    /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Card), {
                        ...
                        children: /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Flex), {
                            ...
                            gap: 1,
                            children: [
                                /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanity_unstable.SanityPreview), {
                                    layout: "default",
                                    value: item,
                                ...
                                /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityicons.DragHandleIcon), {
                                    style: {
                                        flexShrink: 0
                                    }
                                }, void 0, false, {
                    ...
                    /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Card), {
                        ...
                        children: /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Flex), {
                            ...
                            gap: 1,
                            children: [
                                /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $5acb438b2707cb7e$export$2e2bcd8739ae039), {
                                    userList: userList,
                                    assignees: assignees,
                                ...
                                /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $9b2a1e1488934d06$export$2e2bcd8739ae039), {
                                    id: item._id,
                                    type: item._type
                                }, void 0, false, {
                                    fileName: "src/components/DocumentCard/index.tsx",
...
function $8f72b9366267ef2f$export$2e2bcd8739ae039(props) {
    const { _id: _id , _type: _type , documentId: documentId , state: state , onComplete: onComplete  } = props;
    ...
    } else // Clean up if it's not going to un/publish
    onComplete(_id);
    // return null
...
function $74991263f42a6df6$export$407e3aaec0ba74ab(schemaTypes) {
    const toast = (0, $dyHF6$sanityui.useToast)();
    const client = (0, $dyHF6$sanity.useClient)();
    const [localDocuments, setLocalDocuments] = (0, ($parcel$interopDefault($dyHF6$react))).useState([]);
    // Get and listen to changes on documents + workflow metadata documents
    const { data: data , loading: loading , error: error  } = (0, $dyHF6$sanitypluginutils.useListeningQuery)($74991263f42a6df6$var$COMBINED_QUERY, {
        params: {
        ...
        if (data) {
            ...
            const documentsWithMetadata = data.documents.reduce((acc, cur)=>{
                ...
                if (!cur._id.startsWith(`drafts.`)) {
                    ...
                    const alsoHasDraft = Boolean(data.documents.find((doc)=>doc._id === `drafts.${cur._id}`));
    ...
    const move = (0, ($parcel$interopDefault($dyHF6$react))).useCallback((draggedId, destination, states)=>{
        // Optimistic update
        const currentLocalData = localDocuments;
        const newLocalDocuments = localDocuments.map((item)=>{
            if (item._metadata.documentId === draggedId) return {
                ...item,
                _metadata: {
                    ...item._metadata,
        ...
        client.patch(`workflow-metadata.${documentId}`).ifRevisionId(_rev).set({
            state: newStateId
        }).commit().then(()=>{
            return toast.push({
...
function $441aa5f1a1aa7376$export$2e2bcd8739ae039(props) {
    const { schemaTypes: schemaTypes = [] , states: states = []  } = props?.tool?.options ?? {};
    const [mutatingDocs, setMutatingDocs] = (0, ($parcel$interopDefault($dyHF6$react))).useState([]);
    const mutationFinished = (0, ($parcel$interopDefault($dyHF6$react))).useCallback((documentId)=>{
    ...
    const { workflowData: workflowData , operations: operations  } = (0, $74991263f42a6df6$export$407e3aaec0ba74ab)(schemaTypes);
    ...
    const documentIdsWithoutMetadata = data.filter((doc)=>!doc._metadata).map((d)=>d._id.replace(`drafts.`, ``));
    const handleDragEnd = (0, ($parcel$interopDefault($dyHF6$react))).useCallback((result)=>{
        const { draggableId: draggableId , source: source , destination: destination  } = result;
        console.log(`sending ${draggableId} from ${source.droppableId} to ${destination?.droppableId}`);
        ...
        if (mutatingDoc) setMutatingDocs((current)=>[
                ...current,
                mutatingDoc
            ]);
    }, [
    ...
    if (!states?.length) return /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Container), {
        width: 1,
        padding: 5,
        children: /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanitypluginutils.Feedback), {
            tone: "caution",
    ...
    if (error) return /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Container), {
        width: 1,
        padding: 5,
        children: /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanitypluginutils.Feedback), {
            tone: "critical",
    ...
    return /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$reactjsxdevruntime.Fragment), {
        children: [
            mutatingDocs.length ? /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)("div", {
                style: {
                    position: `absolute`,
                    bottom: 0,
                    background: "red"
                },
                children: mutatingDocs.map((mutate)=>/*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $8f72b9366267ef2f$export$2e2bcd8739ae039), {
                        ...mutate,
            ...
            documentIdsWithoutMetadata.length > 0 && /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Box), {
                paddingY: 5,
                paddingX: 3,
                children: /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Card), {
                    shadow: 1,
            ...
            /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$reactbeautifuldnd.DragDropContext), {
                onDragEnd: handleDragEnd,
                children: /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Grid), {
                    columns: states.length,
                    height: "fill",
                    children: states.map((state, stateIndex)=>/*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Card), {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$reactbeautifuldnd.Droppable), {
                                    droppableId: state.id,
                                    children: (provided, snapshot)=>/*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Card), {
                                            ref: provided.innerRef,
                                            tone: snapshot.isDraggingOver ? `primary` : defaultCardTone,
                                            height: "fill",
                                            children: [
                                                loading ? /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Flex), {
                                                    padding: 5,
                                                    align: "center",
                                                    justify: "center",
                                                    children: /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Spinner), {
                                                        muted: true
                                                    }, void 0, false, {
                                                        fileName: "src/components/WorkflowTool.tsx",
                                                        lineNumber: 149,
                                                ...
                                                data.length > 0 && $441aa5f1a1aa7376$var$filterItemsByState(data, state.id).map((item, itemIndex)=>// The metadata's documentId is always the published one
                                                    /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$reactbeautifuldnd.Draggable), {
                                                        draggableId: item._metadata.documentId,
                                                        index: itemIndex,
                                                        children: (draggableProvided, draggableSnapshot)=>/*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)("div", {
                                                                ref: draggableProvided.innerRef,
                                                                ...draggableProvided.draggableProps,
                                                                ...draggableProvided.dragHandleProps,
                                                                children: /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $d5ee3dea3f734309$export$6a639350e64e609c), {
                                                    ...
                                                    }, item._metadata.documentId, false, {
                                                        fileName: "src/components/WorkflowTool.tsx",
                                                        lineNumber: 156,
                                                        columnNumber: 25
                                                    }, this))
...
function $303e87997ba337ee$export$2e2bcd8739ae039(props) {
    ...
    const userList = (0, $dyHF6$sanitypluginutils.useProjectUsers)();
    const onAssigneeAdd = (0, $dyHF6$react.useCallback)((userId)=>{
        onChange([
    ...
    const onAssigneeRemove = (0, $dyHF6$react.useCallback)((userId)=>{
    ...
    return /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Card), {
        ...
        radius: 3,
        padding: 1,
        children: /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanitypluginutils.UserSelectMenu), {
            open: true,
            value: value,
            userList: userList,
            onAdd: onAssigneeAdd,
...
var $98532ccbbae033ad$export$2e2bcd8739ae039 = (states)=>(0, $dyHF6$sanity.defineType)({
        type: "document",
...
function $426e7d8683c78bcf$export$2fd86b6a55ec93e(id, states) {
    const { data: metadata , loading: loading , error: error ,  } = (0, $dyHF6$sanitypluginutils.useListeningQuery)(`*[_type == "workflow.metadata" && documentId == $id][0]`, {
        params: {
            id: id
        }
    });
...
function $43ea10120cc4b152$export$df3dc3c012683b4b(props, states) {
    const { id: id  } = props;
    const { data: data , loading: loading , error: error  } = (0, $426e7d8683c78bcf$export$2fd86b6a55ec93e)(id, states);
...
function $41b48e41337caf0b$export$2e2bcd8739ae039(props) {
    ...
    const { data: data , loading: loading , error: error  } = (0, $426e7d8683c78bcf$export$2fd86b6a55ec93e)(documentId, states);
    const { state: state  } = data;
    const [mutatingToState, setMutatingToState] = (0, ($parcel$interopDefault($dyHF6$react))).useState(null);
    const client = (0, $dyHF6$sanity.useClient)();
    const toast = (0, $dyHF6$sanityui.useToast)();
    ...
    const changeState = (0, ($parcel$interopDefault($dyHF6$react))).useCallback((publishedId, newState)=>{
        setMutatingToState(newState.id);
        client.patch(`workflow-metadata.${publishedId}`).set({
            state: newState.id
        }).commit().then(()=>{
            toast.push({
                status: "success",
        ...
        children: [
            ...
            /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Card), {
                ...
                children: /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Inline), {
                    space: 1,
                    children: states.map((s)=>/*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Button), {
                            disabled: loading || error || Boolean(mutatingToState),
                            fontSize: 1,
                            tone: "primary",
                            mode: !mutatingToState && s.id === state?.id || s.id === mutatingToState ? `default` : `ghost`,
                            text: s.title,
                            radius: 2,
...
const $329a1cedcedb1349$export$66caea4fbc555daf = (0, $dyHF6$sanity.createPlugin)((config = $329a1cedcedb1349$var$DEFAULT_CONFIG)=>{
    ...
    return {
        ...
        schema: {
            schemaTypes: [
                (0, $98532ccbbae033ad$export$2e2bcd8739ae039)(states)
            ]
        },
        form: {
            renderInput: (inputProps, next)=>{
                if (inputProps.id === `root` && schemaTypes.includes(inputProps.schemaType.name)) return /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $dyHF6$sanityui.Stack), {
                    space: 3,
                    children: /*#__PURE__*/ (0, $dyHF6$reactjsxdevruntime.jsxDEV)((0, $41b48e41337caf0b$export$2e2bcd8739ae039), {
                        ...inputProps,
                        states: states,
        ...
        document: {
            actions: (prev, context)=>{
                ...
                return [
                    (props)=>(0, $727ba349109eb250$export$b562ebadfc48095b)(props, states),
                    (props)=>(0, $b0a39fd621aa5e8a$export$3671238969cffbcf)(props, states),
                    ...prev, 
                ];
            },
            badges: (prev, context)=>{
                if (!schemaTypes.includes(context.schemaType)) return prev;
                return [
                    (props)=>(0, $43ea10120cc4b152$export$df3dc3c012683b4b)(props, states),
                    ...prev
                ];
            }
        },
