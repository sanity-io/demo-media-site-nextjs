...
import $7XdDa$react, {useCallback as $7XdDa$useCallback, useEffect as $7XdDa$useEffect} from "react";
import {createPlugin as $7XdDa$createPlugin, useClient as $7XdDa$useClient, useSchema as $7XdDa$useSchema, useDocumentOperation as $7XdDa$useDocumentOperation, defineType as $7XdDa$defineType, defineField as $7XdDa$defineField} from "sanity";
import {CheckmarkIcon as $7XdDa$CheckmarkIcon, SplitVerticalIcon as $7XdDa$SplitVerticalIcon, DragHandleIcon as $7XdDa$DragHandleIcon, EditIcon as $7XdDa$EditIcon, AddIcon as $7XdDa$AddIcon, ArrowRightIcon as $7XdDa$ArrowRightIcon, ArrowLeftIcon as $7XdDa$ArrowLeftIcon} from "@sanity/icons";
import {Stack as $7XdDa$Stack, useToast as $7XdDa$useToast, useTheme as $7XdDa$useTheme, Container as $7XdDa$Container, Box as $7XdDa$Box, Card as $7XdDa$Card, Button as $7XdDa$Button, Grid as $7XdDa$Grid, Label as $7XdDa$Label, Flex as $7XdDa$Flex, Spinner as $7XdDa$Spinner, Popover as $7XdDa$Popover, Text as $7XdDa$Text, Inline as $7XdDa$Inline} from "@sanity/ui";
import {useProjectUsers as $7XdDa$useProjectUsers, Feedback as $7XdDa$Feedback, UserSelectMenu as $7XdDa$UserSelectMenu, useListeningQuery as $7XdDa$useListeningQuery} from "sanity-plugin-utils";
import {DragDropContext as $7XdDa$DragDropContext, Droppable as $7XdDa$Droppable, Draggable as $7XdDa$Draggable} from "react-beautiful-dnd";
import {SanityPreview as $7XdDa$SanityPreview, useRouter as $7XdDa$useRouter, UserAvatar as $7XdDa$UserAvatar} from "sanity/_unstable";
import {setIfMissing as $7XdDa$setIfMissing, insert as $7XdDa$insert, unset as $7XdDa$unset} from "sanity/form";
...
$parcel$export($357f50a17451fe9f$exports, "workflow", () => $357f50a17451fe9f$export$66caea4fbc555daf, (v) => $357f50a17451fe9f$export$66caea4fbc555daf = v);
...
function $a1e1b06e1d70644d$export$2e2bcd8739ae039(props) {
    ...
    return /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Button), {
...
function $2762f88b6926ff09$export$2e2bcd8739ae039(props) {
    ...
    const visibleUsers = (0, $7XdDa$react).useMemo(()=>users.slice(0, max), [
        users
    ]);
    if (!users?.length) return null;
    return /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Flex), {
        align: "center",
        children: [
            visibleUsers.map((user)=>/*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Box), {
                    style: {
                        marginRight: -5
                    },
                    children: /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$UserAvatar), {
                        user: user
                    }, void 0, false, {
            ...
            len > max && /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Box), {
                paddingLeft: 2,
...
function $7c13335f3b026c0c$export$2e2bcd8739ae039(props) {
    ...
    const addAssignee = (0, $7XdDa$react).useCallback((id, userId)=>{
    ...
    const removeAssignee = (0, $7XdDa$react).useCallback((id, userId)=>{
    ...
    const clearAssignees = (0, $7XdDa$react).useCallback((id)=>{
        client.patch(`workflow-metadata.${id}`).unset([
            `assignees`
        ]).commit().then((res)=>res).catch((err)=>{
            console.error(err);
    ...
    return /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Popover), {
        // @ts-ignore
        // ref={setPopoverRef}
        // onKeyDown={handleKeyDown}
        content: /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$UserSelectMenu), {
            // open={false}
            style: {
                maxHeight: 300
            },
        ...
        portal: true,
        open: openId === documentId,
        children: !assignees || assignees.length === 0 ? /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Button), {
            ...
            lineNumber: 104,
            columnNumber: 9
        }, this) : /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Button), {
            onClick: ()=>setOpenId(documentId),
            padding: 0,
            mode: "bleed",
            style: {
            ...
            children: /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $2762f88b6926ff09$export$2e2bcd8739ae039), {
...
function $5c3c0b7a0d5caa06$export$6a639350e64e609c(props) {
    ...
    return /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Box), {
        paddingY: 2,
        paddingX: 3,
        children: /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Card), {
            radius: 2,
                ...
                children: [
                    /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Card), {
                        ...
                        children: /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Flex), {
                            ...
                            gap: 1,
                            children: [
                                /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$SanityPreview), {
                                    layout: "default",
                                    value: item,
                                ...
                                /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$DragHandleIcon), {
                                    style: {
                                        flexShrink: 0
                                    }
                                }, void 0, false, {
                    ...
                    /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Card), {
                        ...
                        children: /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Flex), {
                            ...
                            gap: 1,
                            children: [
                                /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7c13335f3b026c0c$export$2e2bcd8739ae039), {
                                    userList: userList,
                                    assignees: assignees,
                                ...
                                /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $a1e1b06e1d70644d$export$2e2bcd8739ae039), {
                                    id: item._id,
                                    type: item._type
                                }, void 0, false, {
                                    fileName: "src/components/DocumentCard/index.tsx",
...
function $8383cdec849e0625$export$407e3aaec0ba74ab(schemaTypes) {
    ...
    const { data: data , loading: loading , error: error  } = (0, $7XdDa$useListeningQuery)($8383cdec849e0625$var$COMBINED_QUERY, {
        params: {
    ...
    const move = (0, $7XdDa$react).useCallback((draggedId, destination, states)=>{
        // Optimistic update
...
function $c709c543688c251a$export$2e2bcd8739ae039(props) {
    ...
    const { workflowData: workflowData , operations: operations  } = (0, $8383cdec849e0625$export$407e3aaec0ba74ab)(schemaTypes);
    ...
    const handleDragEnd = (0, $7XdDa$react).useCallback((result)=>{
    ...
    if (!states?.length) return /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Container), {
        width: 1,
        padding: 5,
        children: /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Feedback), {
            tone: "caution",
    ...
    if (error) return /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Container), {
        width: 1,
        padding: 5,
        children: /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Feedback), {
            tone: "critical",
    ...
    return /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Fragment), {
        children: [
            mutatingDocs.length ? /*#__PURE__*/ (0, $7XdDa$jsxDEV)("div", {
                style: {
                    position: `absolute`,
                    bottom: 0,
                    background: "red"
                },
                children: mutatingDocs.map((mutate)=>/*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $b2b7bddbf167eb21$export$2e2bcd8739ae039), {
                        ...mutate,
            ...
            documentIdsWithoutMetadata.length > 0 && /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Box), {
                paddingY: 5,
                paddingX: 3,
                children: /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Card), {
                    shadow: 1,
            ...
            /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$DragDropContext), {
                onDragEnd: handleDragEnd,
                children: /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Grid), {
                    columns: states.length,
                    height: "fill",
                    children: states.map((state, stateIndex)=>/*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Card), {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Droppable), {
                                    droppableId: state.id,
                                    children: (provided, snapshot)=>/*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Card), {
                                            ref: provided.innerRef,
                                            tone: snapshot.isDraggingOver ? `primary` : defaultCardTone,
                                            height: "fill",
                                            children: [
                                                loading ? /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Flex), {
                                                    padding: 5,
                                                    align: "center",
                                                    justify: "center",
                                                    children: /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Spinner), {
                                                        muted: true
                                                    }, void 0, false, {
                                                        fileName: "src/components/WorkflowTool.tsx",
                                                        lineNumber: 149,
                                                ...
                                                data.length > 0 && $c709c543688c251a$var$filterItemsByState(data, state.id).map((item, itemIndex)=>// The metadata's documentId is always the published one
                                                    /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Draggable), {
                                                        draggableId: item._metadata.documentId,
                                                        index: itemIndex,
                                                        children: (draggableProvided, draggableSnapshot)=>/*#__PURE__*/ (0, $7XdDa$jsxDEV)("div", {
                                                                ref: draggableProvided.innerRef,
                                                                ...draggableProvided.draggableProps,
                                                                ...draggableProvided.dragHandleProps,
                                                                children: /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $5c3c0b7a0d5caa06$export$6a639350e64e609c), {
...
function $c1d876d802d247dc$export$2e2bcd8739ae039(props) {
    ...
    const userList = (0, $7XdDa$useProjectUsers)();
    const onAssigneeAdd = (0, $7XdDa$useCallback)((userId)=>{
        onChange([
    ...
    const onAssigneeRemove = (0, $7XdDa$useCallback)((userId)=>{
    ...
    return /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Card), {
        ...
        radius: 3,
        padding: 1,
        children: /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$UserSelectMenu), {
            open: true,
            value: value,
            userList: userList,
            onAdd: onAssigneeAdd,
...
var $5a543b4dc751e89f$export$2e2bcd8739ae039 = (states)=>(0, $7XdDa$defineType)({
        type: "document",
...
function $4b2f92acbbf80a2e$export$2fd86b6a55ec93e(id, states) {
    const { data: metadata , loading: loading , error: error ,  } = (0, $7XdDa$useListeningQuery)(`*[_type == "workflow.metadata" && documentId == $id][0]`, {
        params: {
            id: id
        }
    });
...
function $b6e6f4855fd7425f$export$df3dc3c012683b4b(props, states) {
    const { id: id  } = props;
    const { data: data , loading: loading , error: error  } = (0, $4b2f92acbbf80a2e$export$2fd86b6a55ec93e)(id, states);
...
function $ce05876ead579e3a$export$2e2bcd8739ae039(props) {
    ...
    const { data: data , loading: loading , error: error  } = (0, $4b2f92acbbf80a2e$export$2fd86b6a55ec93e)(documentId, states);
    const { state: state  } = data;
    ...
    const changeState = (0, $7XdDa$react).useCallback((publishedId, newState)=>{
        ...
        children: [
            ...
            /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Card), {
                ...
                children: /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Inline), {
                    space: 1,
                    children: states.map((s)=>/*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Button), {
...
const $357f50a17451fe9f$export$66caea4fbc555daf = (0, $7XdDa$createPlugin)((config = $357f50a17451fe9f$var$DEFAULT_CONFIG)=>{
    ...
    return {
        ...
        schema: {
            schemaTypes: [
                (0, $5a543b4dc751e89f$export$2e2bcd8739ae039)(states)
            ]
        },
        form: {
            renderInput: (inputProps, next)=>{
                if (inputProps.id === `root` && schemaTypes.includes(inputProps.schemaType.name)) return /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $7XdDa$Stack), {
                    space: 3,
                    children: /*#__PURE__*/ (0, $7XdDa$jsxDEV)((0, $ce05876ead579e3a$export$2e2bcd8739ae039), {
                        ...inputProps,
                        states: states,
        ...
        document: {
            actions: (prev, context)=>{
                ...
                return [
                    (props)=>(0, $a5181f41bd4dd8b3$export$b562ebadfc48095b)(props, states),
                    (props)=>(0, $8f373bad46be924e$export$3671238969cffbcf)(props, states),
                    ...prev, 
                ];
            },
            badges: (prev, context)=>{
                if (!schemaTypes.includes(context.schemaType)) return prev;
                return [
                    (props)=>(0, $b6e6f4855fd7425f$export$df3dc3c012683b4b)(props, states),
                    ...prev
                ];
            }
        },
...
export {$357f50a17451fe9f$export$66caea4fbc555daf as workflow, $357f50a17451fe9f$exports as default};
